            ...
            <div class="x_content">
                ...
                <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" value="<?php echo $row['first_name']; ?>" name="first_name" id="first-name2" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" value="<?php echo $row['last_name']; ?>" name="last_name" id="last-name2" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="nic" value="<?php echo $row['nic']; ?>" class="form-control col-md-7 col-xs-12" maxlength="12">
                    ...
                    <!---        <div class="form-group">
									...
									<div class="col-md-4">
                                        <select name="admin_type" class="select2_single form-control" required="required" tabindex="-1" >
                                            <option value="<?php // echo $row['admin_type']; 
                ...
                if (isset($_POST['update'])) {
                    ...
                    if ($error > 0) {
                        ...
                        if ($password != $confirm_password) {
                            ...
                            mysqli_query($con, " UPDATE admin SET first_name='$first_name', last_name='$last_name',nic='$nic',email_id='$email_id',contact='$contact' , password='$password', 
