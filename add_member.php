        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                if (isset($_POST['submit'])){
					...
					$result=mysqli_query($con,"select * from user WHERE student_id='$student_id' OR contact='$contact'") or die (mysqli_error($con));
					...
					{		
						mysqli_query($con,"insert into user (student_id,first_name, last_name, contact, gender, address, type, branch, user_added)
						values ('$student_id','$first_name', '$last_name', '$contact', '$gender', '$address', '$type', '$branch', NOW())")or die(mysqli_error($con));
