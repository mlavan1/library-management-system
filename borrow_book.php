...
<?php 
	...
	$user_query = mysqli_query($con,"SELECT * FROM user WHERE student_id = '$student_id' ");
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					...
					?>
					<h2>
					Borrower Name : <span style="color:maroon;"><?php echo $row['first_name']."  ".$row['last_name']; ?></span>
					</h2>
						...
						<div class="table-responsive">
							...
							<?php
								if (isset($_POST['return'])) {
									...
									$admin_row1=$report_history_row1['first_name']."  ".$report_history_row1['last_name'];	
							...
							<?php 
								if (isset($_POST['borrow'])){
									...
									if ($countBorrowed['books_allowed'] == $allowed['qntty_books']){
										...
										echo "<script>alert('This book is LOST!'); window.location='borrow_book.php?student_id=".$student_id."'</script>";
									}elseif ($bookStatus['remarks'] == "Not Available"){
										echo "<script>alert('Book Already Issued to Someone!'); window.location='borrow_book.php?student_id=".$student_id."'</script>";
									}else{
